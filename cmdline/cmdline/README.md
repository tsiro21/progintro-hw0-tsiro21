...
byte6:Με την εντολή cd μπήκα στον φάκελο tmp και με την εντολή unzip byte6.zip δημιουργήθηκε ένα νέο αρχείο byte6.txt. Κάνοντάς το cat πήρα το κλειδί.

byte7: Με την εντολή cd /tmp μπήκα στον φάκελο tmp και κάνοντας tar -xf byte7.tar.gz δημιουργήθηκε ένα extract file byte7.tar και με την εντολή cat byte7.tar πήρα το κλειδί.
